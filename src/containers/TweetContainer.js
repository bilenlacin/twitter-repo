  ...
  tweetPush = () => {
    ...
    return tweets.map((tweet) => {
      return (
        <Tweet
          tweet={tweet}
          increaseTweetLike={this.props.increaseTweetLike}
          decreaseTweetLike={this.props.decreaseTweetLike}
          // showTweetLikeNumber={this.props.showTweetLikeNumber}
        />
      );
    });
  };
...
export default withRouter(
  connect(mapStateToProps, {
    ...
    decreaseTweetLike: decreaseTweetLike,
  })(TweetContainer)
);
